...
if file_ren and file_real:
    ...
    tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Sesuai RUP","Hanya Realisasi","Belum Terealisasi","Swakelola Tercatat","Swakelola Tidak Tercatat","Tokodaring"])
